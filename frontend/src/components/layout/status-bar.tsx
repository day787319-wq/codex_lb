...
function getRoutingLabel(
  strategy: "usage_weighted" | "round_robin" | "threshold_rotation",
  sticky: boolean,
  ...
  if (strategy === "threshold_rotation") {
    return sticky ? "Threshold rotation + Sticky threads" : "Threshold rotation";
  }
