...
describe("RoutingSettings", () => {
  ...
  it("renders the threshold rotation option when selected", () => {
    render(
      <RoutingSettings
        settings={{ ...BASE_SETTINGS, routingStrategy: "threshold_rotation" }}
        busy={false}
        onSave={vi.fn().mockResolvedValue(undefined)}
      />,
    );

    expect(screen.getByText("Threshold rotation")).toBeInTheDocument();
  });
});
