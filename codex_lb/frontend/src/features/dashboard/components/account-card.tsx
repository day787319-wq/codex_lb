import { Clock, ExternalLink, Pin, Play, RotateCcw } from "lucide-react";
...
type AccountAction = "details" | "resume" | "reauth" | "use_only";
...
export function AccountCard({
  ...
  return (
    <div
      ...
      className={cn(
        "card-hover rounded-xl border bg-card p-4 transition-colors",
        isCurrentRouted && "border-primary/40 bg-primary/5 ring-1 ring-primary/20",
      )}
    >
      {/* Header */}
      ...
      <div className="mt-3 flex items-center gap-1.5 border-t pt-3">
        ...
        {status !== "deactivated" && (
          <Button
            ...
            onClick={() => onAction?.(account, "use_only")}
          >
            Use Only
          </Button>
        )}
