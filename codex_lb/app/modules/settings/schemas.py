...
class DashboardSettingsResponse(DashboardModel):
    ...
    routing_strategy: str = Field(pattern=r"^(usage_weighted|round_robin|threshold_rotation)$")
...
class DashboardSettingsUpdateRequest(DashboardModel):
    ...
    prefer_earlier_reset_accounts: bool
    routing_strategy: str | None = Field(default=None, pattern=r"^(usage_weighted|round_robin|threshold_rotation)$")
